return {
  ...
  },
  {
    ...
    config = function()
      vim.keymap.set({ 'n', 'v' }, '<A-k>', '<cmd>Treewalker Up<cr>', { noremap = true, silent = true })
      vim.keymap.set({ 'n', 'v' }, '<A-j>', '<cmd>Treewalker Down<cr>', { noremap = true, silent = true })
      vim.keymap.set({ 'n', 'v' }, '<A-l>', '<cmd>Treewalker Right<cr>', { noremap = true, silent = true })
      vim.keymap.set({ 'n', 'v' }, '<A-h>', '<cmd>Treewalker Left<cr>', { noremap = true, silent = true })
      vim.keymap.set('n', '<leader>tj', '<cmd>Treewalker SwapDown<cr>', { noremap = true, silent = true })
      vim.keymap.set('n', '<leader>tk', '<cmd>Treewalker SwapUp<cr>', { noremap = true, silent = true })
