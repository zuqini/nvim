...
-- 'builtin' is nvim's own completion: snippets, buffer words and paths as
-- 'complete' functions under 'autocomplete', with the LSP omnifunc alongside
-- them in the same ranked menu.
vim.g.cmp_engine = vim.env.NVIM_CMP_ENGINE or 'builtin' -- blink | builtin
